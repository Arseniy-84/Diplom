...
export function HallAdd() {
    ...
    return (
        <>
                    ...
                    <div className={styles.halls}>
                        {halls.map((hall) => (
                            <div key={hall.id} className={styles.hall}>
                                ...
                                <img
                                    src={assetPath("Admin/delete-icon.svg")}
            ...
            <Button appereance="admin" className={styles.createHallButton} onClick={() => setShowPopup(true)}>
                Создать зал
            </Button>
            {showPopup && (
                <div className={styles.popupOverlay}>
                    <div className={styles.popupContent}>
                        <PopupCreateHall onClose={() => setShowPopup(false)} onSuccess={handleSuccessCreate} />
                    </div>
                </div>
            )}
        </>
