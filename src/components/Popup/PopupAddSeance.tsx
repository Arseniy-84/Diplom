        ...
        <div className={styles.popup}>
            ...
            <form className={styles.form} onSubmit={submit}>
                <div className={styles["input-block"]}>
                    <label htmlFor="hallName" className={styles.title}>
                        Название зала
                    </label>
                    <select
                        id="hallName"
                ...
                {hallsLoading ? <div className={styles.loading}>Загрузка данных...</div> : error ? <div className={styles.error}>{error}</div> : null}

                <div className={styles.buttons}>
                    <Button type="submit" appereance="admin" disabled={!selectedHallId || !selectedFilmId || !selectedTime}>
                        Добавить сеанс
                    </Button>
